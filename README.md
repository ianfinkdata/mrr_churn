# Revenue Churn Pipeline and Analysis
...
- MySQL
    ...
    - Developed medallion architecture framework

- Python
    - Gemini scaled database "for me" using Pandas and Faker

- PowerBI
    - Recreated initial topline revenue performance report
    - "Now level" analysis and storytelling to identify a problem and recommendations.
